...
export interface BinCheckoutResult extends BinTransaction {
...
export interface ChecklistItem {
  id: number;
  checklistId: number;
  subchecklistId: number | null;
  title: string;
  description: string | null;
  itemOrder: number;
  assigneeId: number | null;
  assignee: ChecklistAssignmentUser | null;
...
export type SubchecklistType = "PRE_SABHA" | "POST_SABHA" | "CUSTOM";

export interface Subchecklist {
  id: number;
  checklistId: number;
  title: string;
  sectionType: SubchecklistType;
  isMandatory: boolean;
  sectionOrder: number;
  createdAt: string;
  updatedAt: string;
